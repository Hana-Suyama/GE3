...
inline Vector4 Vector4::operator-() const { return { -x, -y, -z }; }
inline Vector4 Vector4::operator+() const { return { x, y, z }; }

inline Vector4& Vector4::operator*=(float s) { x *= s; y *= s; z *= s; return *this; }
inline Vector4& Vector4::operator-=(const Vector4& v) { x -= v.x; y -= v.y; z -= v.z; return *this; }
inline Vector4& Vector4::operator+=(const Vector4& v) { x += v.x; y += v.y; z += v.z; return *this; }
inline Vector4& Vector4::operator/=(float s) { x /= s; y /= s; z /= s; return *this; }
