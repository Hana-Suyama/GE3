...
public:
	...
	///	初期化
	/// </summary>
	/// <param name="skyBoxBasic">skyBoxの基盤</param>
	/// <param name="modelManager">モデルマネージャー</param>
	/// <param name="modelFilePath">モデルのファイルパス</param>
	void Initialize(SkyBoxBasic* skyBoxBasic, ModelManager* modelManager, std::string modelFilePath);
...
private:
	...
	// skyBoxの基盤のポインタ
	SkyBoxBasic* skyBoxBasic_ = nullptr;
