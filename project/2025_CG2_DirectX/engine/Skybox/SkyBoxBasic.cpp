...
void SkyBoxBasic::SkyBoxPreDraw()
{
...
void SkyBoxBasic::CreatePSO()
{
	...
	//Shaderをコンパイルする
	Microsoft::WRL::ComPtr<IDxcBlob> vertexShaderBlob = directXBasic_->CompileShader(L"resources/shaders/SkyBox.VS.hlsl",
		L"vs_6_0", logger_);
	assert(vertexShaderBlob != nullptr);

	Microsoft::WRL::ComPtr<IDxcBlob> pixelShaderBlob = directXBasic_->CompileShader(L"resources/shaders/SkyBox.PS.hlsl",
		L"ps_6_0", logger_);
